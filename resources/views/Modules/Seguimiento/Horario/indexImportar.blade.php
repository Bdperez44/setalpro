                ...
                <form method="POST" action='{{ url("seguimiento/horario/importar") }}' enctype="multipart/form-data">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <select id="ficha" data-url="{{url('seguimiento/horario/validarficha')}}" name="ficha" class="form-control" required>
                                ...
                                <td>
                                    <select id="programa" data-url="{{url('seguimiento/horario/validarprograma')}}" name="programa" class="form-control">
                                        <option value="">Seleccione...</option>
...
@section('plugins-js')
	...
	<script type="text/javascript">
		$(document).ready(function () {
            ...
            $(document).on('click','#quitardiv',function(){                   
                $("#contenidodiv").remove();                     
            });
