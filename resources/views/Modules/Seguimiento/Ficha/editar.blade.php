        ...
        <div class="box ui-draggable ui-droppable">
            ...
            <div class="box-content" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        @if(isset($ficha[0]->pla_ins_lider))
                            <select data-rel="chosen" id="par_identificacion" name="par_identificacion" class="" required="required">
                                ...
                                <?php                                 
                                    if($key==$ficha[0]->pla_ins_lider){?>
                                        <option value="{{ $key }}" selected>{{ $instructor }}</option>  <?php                                  
                                    } 
                                    else{?>
                                        <option value="{{ $key }}">{{ $instructor }}</option> <?php                            
                                    } 
                                ?>
                            ...
                            @else
                                <select data-rel="chosen" id="par_identificacion" name="par_identificacion" class="" required="required">
                                    <option value="999999999" selected> Pendiente por asignar</option>          
                                </select>
                        @endif
